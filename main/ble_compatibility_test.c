...
#define SAMPLE_DEVICE_NAME          "BEE_CON"
...
#define manufacturer_data1 (uint8_t*)"Hello"
//static uint8_t manufacturer_data[] = {0x4C, 0x00, 0x02, 0x15, 0x01};
//static uint8_t service_data[] = {0x01, 0x02, 0x03};
//static uint8_t test_service[7] = {'s','e'};


static uint8_t adv_config_done       = 0;
static uint8_t curpage[5] = {'0','1','2','3','4'};
...
static esp_ble_adv_data_t adv_data = {
    ...
    .max_interval        = 0x40,
    .appearance          = 0x00,
    .manufacturer_len    = 0,//sizeof(manufacturer_data),    //TEST_MANUFACTURER_DATA_LEN,
    .p_manufacturer_data = NULL,//manufacturer_data, //test_manufacturer,
    .service_data_len    = 7,//sizeof(service_data),
    .p_service_data      = &test_service[0],//service_data,
            ...
            if (!param->write.is_prep){
                ...
                if(gatt_db_handle_table[IDX_CHAR_VAL_A] == param->write.handle) {
                    ...
                    if(memcmp(write_data, param->write.value, param->write.len) == 0) {
                        ...
                        task_ssd1306_display_text_in_line(param->write.value,index1++);
